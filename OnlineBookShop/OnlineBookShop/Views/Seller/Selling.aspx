        ...
        <div class="col-md-5">
            ...
            <div class="row">
                <div class="col">
                    <div class="mt-3">
                            ...
                            <input type="email" placeholder="Your Email Here" autocomplete="off" class="form-control" runat="server" id="BNameTb" />
                     </div>
                </div>
                 <div class="col">
                    <div class="mt-3">
                            <label for="" class="form-label text-success">Price Name</label>
                            <input type="email" placeholder="Your Email Here" autocomplete="off" class="form-control" runat="server" id="BPriceTb" />
                     </div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div class="mt-3">
                            <label for="" class="form-label text-success">Book Name</label>
                            <input type="email" placeholder="Your Email Here" autocomplete="off" class="form-control" runat="server" id="BQtyTb" />
                     </div>
                </div>
                 <div class="col">
                    <div class="mt-3">
            ...
            <div class="row mt-3">
                <div class="col d-grid">
                    <asp:Button Text="Save" runat="server" ID="AddToBillBtn" class="btn-warning btn-block btn" />
