                ...
                <div class="col">
                 ...
                 <div class="col">
                    <div class="mt-3">
                            ...
                            <input type="email" placeholder="Your Email Here" autocomplete="off" class="form-control" runat="server" id="Email1" />
                     </div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div class="mt-3">
                            <label for="" class="form-label text-success">Book Name</label>
                            <input type="email" placeholder="Your Email Here" autocomplete="off" class="form-control" runat="server" id="Email2" />
                     </div>
                </div>
                 <div class="col">
                    <div class="mt-3">
                            <label for="" class="form-label text-success">Price Name</label>
                            <input type="email" placeholder="Your Email Here" autocomplete="off" class="form-control" runat="server" id="Email3" />
                     </div>
                </div>
            </div>
             <div class="row mt-5">
